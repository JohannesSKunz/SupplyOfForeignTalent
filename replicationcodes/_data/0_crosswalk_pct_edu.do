...
**	Generate Oc-Wage Percitiles adjusted from Autor Dorn, education
**
********************************************************************************
*Settings
clear all
...
g edu = edu3 == "1high"
collapse (count) num_obs = edu (mean) edu [aw = wklhrs] , by(isco084)
...
sort isco084 perc
compress
save _temp/percentiles_edu.dta, replace
